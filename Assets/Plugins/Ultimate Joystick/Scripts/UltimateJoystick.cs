...
public class UltimateJoystick : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
	...
	/* ----- > PUBLIC EVENTS < ----- */
	public event Action CustomPointerUp;
	public event Action CustomPointerDown;
	public event Action CustomPointerDrag;
